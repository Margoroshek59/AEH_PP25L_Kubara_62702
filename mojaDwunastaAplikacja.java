...
public class mojaDwunastaAplikacja {
    public static void main(String[] args) {
         ...
         */
                ...
                System.out.print("Wprowadz sciezkę do pliku wejsciowego: ");
                ...
                try (BufferedReader reader = new BufferedReader(new FileReader(inputFile))) {
                    ...
                    try (BufferedWriter writer = new BufferedWriter(new FileWriter(outputFilePath))) {
                        ...
                        System.out.println("Wynik zapisany do pliku: " + outputFilePath);
                    }

                } catch (IOException e) {
                    System.out.println("Blad podczas pracy z plikiem: " + e.getMessage());
                }
